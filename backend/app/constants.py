...
TREE_GROWTH_VIGOR = EnumGroup("tree_growth_vigor", [
    ("vigorous", "旺盛"),
    ("normal", "正常"),
    ("weak", "衰弱"),
    ("endangered", "濒危"),
...
TREE_MEASURE_TYPE = EnumGroup("tree_measure_type", [
    ("rejuvenation", "复壮"),
    ("support", "支撑加固"),
    ("anticorrosion", "防腐处理"),
    ("prune", "修剪"),
...
ENUM_GROUPS = {
    ...
    "tree_growth_vigor": TREE_GROWTH_VIGOR,
    "tree_measure_type": TREE_MEASURE_TYPE,
}
